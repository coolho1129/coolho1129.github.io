...
<!-- Main Wrapper -->
<div style="max-width: 1080px; margin: 0 auto; padding: 40px; line-height: 1.7; font-size: 18px; font-family: sans-serif;">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: flex-start;">
    ...
    <div style="flex: 1; min-width: 300px; max-width: 860px;">
      ...
      <p style="font-size: 20px;">
        ...
        <strong>B.S.</strong> degree in <strong><a href="https://cse.knu.ac.kr/">Computer Science and Engineering</strong></a> from 
      ...
      <!-- Combined Section: Work, Awards, Publications -->
