...
<div style="max-width: 1080px; margin: 0 auto; padding: 40px; font-size: 18px; line-height: 1.75; font-family: 'Segoe UI', sans-serif; color: #222;">
  ...
  <div style="display: flex; flex-wrap: wrap; gap: 40px; align-items: flex-start;">
    ...
    <div style="flex: 0 0 220px; text-align: center;">
      <img src="../images/about.jpg" alt="profile" style="border-radius: 50%; width: 180px; margin-bottom: 16px;">
      <h2 style="font-size: 22px; margin: 0;"><strong>Chanho Kim</strong></h2>
      <p style="font-size: 15px; margin: 4px 0;">M.S./Ph.D. Student</p>
      <p style="font-size: 15px; margin: 4px 0;"><a href="https://aigs.unist.ac.kr/">AIGS, UNIST</a></p>
      <p style="margin-top: 8px;">
        <a href="https://linkedin.com/in/chanho-kim-891a542a2" style="margin-right: 10px;">LinkedIn</a>
    ...
    <div style="flex: 1; min-width: 300px; max-width: 860px;">
      ...
      <ul style="padding-left: 20px; margin: 0;">
        <li><strong>Assistant Researcher</strong>, <a href="https://vision.unist.ac.kr/intro.html">UVLL</a>, UNIST (May 2025 – Present)</li>
